...
This plugin should compatible with Redmine 0.9.x, 1.x, 1.3.x, 1.4.x as well as with the current Redmine trunk.

It was last tested against Redmine 1.4.0

==Obtaining 

<i>URL of the GitHub repository: http://github.com/jbutz/redmine_newissuealerts/tree/master</i>

The source of this plugin can be "cloned" from the GitHub-repo using:

<tt>$ cd {RAILS_ROOT}/vendor/plugins && git clone git://github.com/jbutz/redmine_newissuealerts.git</tt>
